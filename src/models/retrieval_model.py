...
def get_retrieval_model():
    retrieval_model_path = "./models/retrieval_model.pth" # TODO: Move this to a config file
    ...
    model50 = RetrievalModel(res50_extractor, network_head, loss, validation_path_many=None, validation_path_singles=None, root=None)
    state_dict = torch.load(retrieval_model_path)
    state_dict = {"model." + k : v for k, v in state_dict.items()}
    model50.load_state_dict(state_dict)
